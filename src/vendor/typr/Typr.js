// Vendored from https://github.com/photopea/Typr.js (MIT License, (c) Photopea).
// Local modification: ESM export shim appended for Vite/TS consumption.
...
Typr["parse"] = function(buff)
{
	...
	//console.log(out);  // [ComfyTV] silence upstream debug log
...
Typr["B"] = {
	...
	_tdec : (typeof TextDecoder !== "undefined") ? new TextDecoder() : null,  // [ComfyTV] window→global for SSR/test envs
