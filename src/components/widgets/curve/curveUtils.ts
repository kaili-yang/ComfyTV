import { CURVE_INTERPOLATIONS } from '@/components/widgets/curve/types'
import type { CurveData, CurveInterpolation, CurvePoint } from '@/components/widgets/curve/types'
